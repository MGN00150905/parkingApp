...
return array(
    ...
    'LVR\\CreditCard\\CardCvc' => $vendorDir . '/laravel-validation-rules/credit-card/src/CardCvc.php',
    'LVR\\CreditCard\\CardExpirationDate' => $vendorDir . '/laravel-validation-rules/credit-card/src/CardExpirationDate.php',
    'LVR\\CreditCard\\CardExpirationMonth' => $vendorDir . '/laravel-validation-rules/credit-card/src/CardExpirationMonth.php',
    'LVR\\CreditCard\\CardExpirationYear' => $vendorDir . '/laravel-validation-rules/credit-card/src/CardExpirationYear.php',
    'LVR\\CreditCard\\CardNumber' => $vendorDir . '/laravel-validation-rules/credit-card/src/CardNumber.php',
    'LVR\\CreditCard\\Cards\\AmericanExpress' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/AmericanExpress.php',
    'LVR\\CreditCard\\Cards\\Card' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Card.php',
    'LVR\\CreditCard\\Cards\\Dankort' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Dankort.php',
    'LVR\\CreditCard\\Cards\\DinersClub' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/DinersClub.php',
    'LVR\\CreditCard\\Cards\\Discovery' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Discovery.php',
    'LVR\\CreditCard\\Cards\\Forbrugsforeningen' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Forbrugsforeningen.php',
    'LVR\\CreditCard\\Cards\\Jcb' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Jcb.php',
    'LVR\\CreditCard\\Cards\\Maestro' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Maestro.php',
    'LVR\\CreditCard\\Cards\\Mastercard' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Mastercard.php',
    'LVR\\CreditCard\\Cards\\UnionPay' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/UnionPay.php',
    'LVR\\CreditCard\\Cards\\Visa' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/Visa.php',
    'LVR\\CreditCard\\Cards\\VisaElectron' => $vendorDir . '/laravel-validation-rules/credit-card/src/Cards/VisaElectron.php',
    'LVR\\CreditCard\\Contracts\\CreditCard' => $vendorDir . '/laravel-validation-rules/credit-card/src/Contracts/CreditCard.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardChecksumException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardChecksumException.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardCvcException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardCvcException.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardException.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardExpirationDateException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardExpirationDateException.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardLengthException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardLengthException.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardNameException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardNameException.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardPatternException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardPatternException.php',
    'LVR\\CreditCard\\Exceptions\\CreditCardTypeException' => $vendorDir . '/laravel-validation-rules/credit-card/src/Exceptions/CreditCardTypeException.php',
    'LVR\\CreditCard\\ExpirationDateValidator' => $vendorDir . '/laravel-validation-rules/credit-card/src/ExpirationDateValidator.php',
    'LVR\\CreditCard\\Factory' => $vendorDir . '/laravel-validation-rules/credit-card/src/Factory.php',
    ...
    'Rap2hpoutre\\LaravelCreditCardValidator\\ServiceProvider' => $vendorDir . '/rap2hpoutre/laravel-credit-card-validator/src/ServiceProvider.php',
